/**
 * Origin from any project connected to an org:
 * Review folder .sfdx/orgs/<username>/metadata/metadataTypes.json
 * TODO: to find al alternative way of this to identify strategies etc.
 */
export const typeInfos = {
  typeDefs: {
    ...
    SurveySettings: {
      metadataName: 'SurveySettings',
      isAddressable: true,
      isSourceTracked: true,
      ext: 'survey',
      hasContent: false,
      defaultDirectory: 'surveySettings',
      nameForMsgs: 'Survey Settings',
      nameForMsgsPlural: 'Survey Settingses',
      contentIsBinary: false,
      hasStandardMembers: false,
      deleteSupported: true,
      decompositionConfig: {
